const LOCATIONS = [
  ...
  },
  {
    ...
    category: "Cafe",
    categoryId: "Food",
    image: "./images/brownbkk1.jpg",
    rating: 4.7,
    description: "A popular specialty coffee café serving espresso, pastries, and brunch.",
    locationtxt: "Street 294, BKK1",
    location: "https://maps.google.com/?q=Brown+Coffee+BKK1+Street+294+Phnom+Penh",
    area: "BKK1",
    price: "$$",
    reviews: ["Excellent coffee and a cozy place to study."],
    tags: "bkk1"
  },
  {
    ...
    rating: 4.6,
    description: "Modern café known for premium coffee, matcha, and desserts.",
    locationtxt: "Street 240, BKK1",
    location: "https://maps.google.com/?q=The+Coffee+Academics+Street+240+Phnom+Penh",
    area: "BKK1",
    price: "$$",
    reviews: ["Beautiful interior and high quality coffee."],
    tags: "bkk1"
  },

  {
    ...
    rating: 4.7,
    description: "A famous social enterprise serving modern Cambodian cuisine.",
    locationtxt: "Street 13, Daun Penh",
    location: "https://maps.google.com/?q=Friends+the+Restaurant+Street+13+Phnom+Penh",
    area: "Daun Penh",
    price: "$$",
    reviews: ["Amazing food while supporting a meaningful cause."],
    tags: "daunpenh"
  },
  {
    name: "Kravan Restaurant",
    category: "Khmer Restaurant",
    categoryId: "Food",
    image: "./images/kraven.jpg",
    rating: 4.6,
    description: "Elegant restaurant offering traditional Khmer flavors with a modern twist.",
    locationtxt: "Near Royal Palace",
    location: "https://maps.google.com/?q=Kravan+Restaurant+Royal+Palace+Phnom+Penh",
    area: "Daun Penh",
    price: "$$$",
    reviews: ["Beautiful presentation and authentic Cambodian dishes."],
    tags: "daunpenh"
  },
  {
    ...
    category: "Cafe",
    categoryId: "Food",
    image: "./images/brownriver.jpg",
    rating: 4.5,
    description: "A riverside café perfect for coffee, pastries, and relaxing views.",
    locationtxt: "Sisowath Quay",
    location: "https://maps.google.com/?q=Brown+Riverside+Sisowath+Quay+Phnom+Penh",
    area: "Daun Penh",
    price: "$$",
    reviews: ["Great coffee with a relaxing river view."],
    tags: "daunpenh"
  },
  {
    name: "Lot 369 Cafe",
    category: "Cafe",
    categoryId: "Food",
    image: "./images/lot369.jpg",
    rating: 4.7,
    description: "Minimalist café known for excellent coffee and brunch.",
    locationtxt: "Street 450, TTP",
    location: "https://maps.google.com/?q=Lot+369+Cafe+Street+450+Phnom+Penh",
    area: "TTP",
    price: "$$",
    reviews: ["Fantastic brunch and a peaceful atmosphere."],
    tags: "ttp"
  },
  {
    ...
    rating: 4.6,
    description: "A rooftop café and bar offering drinks, food, and sunset views.",
    locationtxt: "Street 440, TTP",
    location: "https://maps.google.com/?q=Sundown+Social+Club+Street+440+Phnom+Penh",
    area: "TTP",
    price: "$$",
    reviews: ["Great place for sunset drinks with friends."],
    tags: "ttp"
  },
  {
    ...
    categoryId: "Food",
    image: "./images/malis.jpg",
    rating: 4.7,
    description: "Award-winning Cambodian restaurant with elegant garden seating.",
    locationtxt: "Sothearos Boulevard",
    location: "https://maps.google.com/?q=Malis+Restaurant+Sothearos+Boulevard+Phnom+Penh",
    area: "Tonle Bassac",
    price: "$$$",
    reviews: ["A must try for refined Khmer cuisine."],
    tags: "tonlebassac"
  },
  {
    name: "Backyard Cafe",
    ...
    rating: 4.6,
    description: "Healthy café serving smoothie bowls, salads, and specialty coffee.",
    locationtxt: "Street 240",
    location: "https://maps.google.com/?q=Backyard+Cafe+Street+240+Phnom+Penh",
    area: "Tonle Bassac",
    price: "$$",
    reviews: ["Fresh, healthy food with excellent coffee."],
    tags: "tonlebassac"
  },
  {
    ...
    rating: 4.5,
    description: "A stylish café combining art, desserts, and handcrafted drinks.",
    locationtxt: "Street 164",
    location: "https://maps.google.com/?q=Gallery+Cafe+Street+164+Phnom+Penh",
    area: "Tonle Bassac",
    price: "$$",
    reviews: ["Lovely desserts and a creative atmosphere."],
    tags: "tonlebassac"
  },
  
  {
    name: "The Bale Lounge",
    category: "Restaurant",
    categoryId: "Food",
    image: "./images/balelounge.jpg",
    rating: 4.7,
    description: "Riverside dining with beautiful sunset views and international cuisine.",
    locationtxt: "National Road 6A",
    location: "https://maps.google.com/?q=The+Bale+Lounge+National+Road+6A+Phnom+Penh",
    area: "Chroy Changvar",
    price: "$$$",
    reviews: ["Outstanding riverside dining experience."],
    tags: "chroychangvar"
  },
  {
    name: "Mekong Café",
    category: "Cafe",
    categoryId: "Food",
    image: "./images/mekongcafe.jpg",
    rating: 4.5,
    description: "Relaxing café overlooking the Mekong River.",
    locationtxt: "Chroy Changvar",
    location: "https://maps.google.com/?q=Mekong+Cafe+Chroy+Changvar+Phnom+Penh",
    area: "Chroy Changvar",
    price: "$$",
    reviews: ["Peaceful coffee spot with scenic river views."],
    tags: "chroychangvar"
  },
  {
    name: "River House BBQ",
    category: "Restaurant",
    categoryId: "Food",
    image: "./images/riverhouse.jpg",
    rating: 4.4,
    description: "Casual restaurant serving grilled meats and Khmer favorites.",
    locationtxt: "Chroy Changvar",
    location: "https://maps.google.com/?q=River+House+BBQ+Chroy+Changvar+Phnom+Penh",
    area: "Chroy Changvar",
    price: "$$",
    reviews: ["Great barbecue with a relaxed riverside setting."],
    tags: "chroychangvar"
  },
  {
    name: "KOI Thé TK",
    ...
    rating: 4.6,
    description: "Popular Taiwanese bubble tea shop inside TK Avenue.",
    locationtxt: "TK Avenue",
    location: "https://maps.google.com/?q=KOI+The+TK+Avenue+Phnom+Penh",
    area: "Toul Kork",
    price: "$",
    reviews: ["One of the best milk tea spots in the area."],
    tags: "toulkork"
  },
  {
    ...
    rating: 4.7,
    description: "Specialty coffee café known for locally roasted beans.",
    locationtxt: "Street 315",
    location: "https://maps.google.com/?q=Feel+Good+Coffee+Street+315+Phnom+Penh",
    area: "Toul Kork",
    price: "$$",
    reviews: ["Excellent espresso and a quiet workspace."],
    tags: "toulkork"
  },
  {
    name: "Park Café TK",
    ...
    categoryId: "Food",
    image: "./images/parkcafe.jpg",
    rating: 4.5,
    description: "A family-friendly café serving Khmer and Western meals.",
    locationtxt: "TK Avenue",
    location: "https://maps.google.com/?q=Park+Cafe+TK+Avenue+Phnom+Penh",
    area: "Toul Kork",
    price: "$$",
    reviews: ["Great for breakfast and casual lunches."],
    tags: "toulkork"
  },

  {
    name: "Starbucks AEON Sen Sok",
    category: "Cafe",
    categoryId: "Food",
    image: "./images/starbucksaeon.jpg",
    rating: 4.6,
    description: "Modern Starbucks with spacious seating inside AEON Mall.",
    locationtxt: "AEON Sen Sok City",
    location: "https://maps.google.com/?q=Starbucks+AEON+Mall+Sen+Sok+City+Phnom+Penh",
    area: "Sen Sok",
    price: "$$",
    reviews: ["Spacious café that's perfect for studying."],
    tags: "sensok"
  },
  {
    name: "Brown Coffee Sen Sok",
    category: "Cafe",
    categoryId: "Food",
    image: "./images/brownsensok.jpg",
    rating: 4.7,
    description: "A popular specialty coffee café with pastries and desserts.",
    locationtxt: "Chip Mong Mega Mall 271",
    location: "https://maps.google.com/?q=Brown+Coffee+Chip+Mong+Mega+Mall+271+Phnom+Penh",
    area: "Sen Sok",
    price: "$$",
    reviews: ["Reliable coffee and a comfortable atmosphere."],
    tags: "sensok"
  },
  {
    name: "Krispy Kreme AEON",
    category: "Dessert Shop",
    categoryId: "Food",
    image: "./images/krispy.jpg",
    rating: 4.5,
    description: "Famous doughnut shop offering fresh desserts and drinks.",
    locationtxt: "AEON Sen Sok City",
    location: "https://maps.google.com/?q=Krispy+Kreme+AEON+Sen+Sok+City+Phnom+Penh",
    area: "Sen Sok",
    price: "$",
    reviews: ["Fresh doughnuts and great coffee for a sweet treat."],
    tags: "sensok"
  },
  {
    name: "Brown Coffee Central Market",
    category: "Cafe",
    categoryId: "Food",
    image: "./images/browncentral.jpg",
    rating: 4.6,
    description: "A stylish café just minutes from Central Market.",
    locationtxt: "Street 63",
    location: "https://maps.google.com/?q=Brown+Coffee+Street+63+Central+Market+Phnom+Penh",
    area: "Prampir Makara",
    price: "$$",
    reviews: ["Great coffee before exploring Central Market."],
    tags: "prampirmakara"
  },
  {
    ...
    category: "Khmer Restaurant",
    categoryId: "Food",
    image: "./images/romdeng.jpg",
    rating: 4.7,
    description: "A famous restaurant serving authentic Cambodian cuisine in a historic villa.",
    locationtxt: "Street 240",
    location: "https://maps.google.com/?q=Romdeng+Restaurant+Street+240+Phnom+Penh",
    area: "Prampir Makara",
    price: "$$",
    reviews: ["Outstanding Khmer dishes in a beautiful setting."],
    tags: "prampirmakara"
  },
  {
    name: "Sorya Food Hall",
    category: "Food Court",
    categoryId: "Food",
    image: "./images/soryafood.jpg",
    rating: 4.4,
    description: "A modern food hall with a variety of Cambodian and international food.",
    locationtxt: "Sorya Center Point",
    location: "https://maps.google.com/?q=Sorya+Center+Point+Food+Hall+Phnom+Penh",
    area: "Prampir Makara",
    price: "$",
    reviews: ["Lots of food choices at affordable prices."],
    tags: "prampirmakara"
  },
  ...
  {
    name: "Wat Moha Montrey",
    category: "Temple",
    categoryId: "Visit",
    image: "./images/watmohamontrey.jpg",
    rating: 4.6,
    description: "A beautiful Buddhist temple known for its golden architecture and peaceful grounds.",
    locationtxt: "Sihanouk Blvd, BKK1",
    location: "https://maps.google.com/?q=Wat+Moha+Montrey+Phnom+Penh",
    area: "BKK1",
    price: "Free",
    reviews: ["A peaceful temple that's less crowded than the city center."],
    tags: "bkk1"
  },
  {
    name: "BKK Market",
    ...
    categoryId: "Visit",
    image: "./images/bkkmarket.jpg",
    rating: 4.3,
    description: "A neighborhood market selling local snacks, clothes, and fresh produce.",
    locationtxt: "Street 163, BKK1",
    location: "https://maps.google.com/?q=BKK+Market+Phnom+Penh",
    area: "BKK1",
    price: "Free",
    reviews: ["Great place to experience everyday local life."],
    tags: "bkk1"
  },
  {
    name: "Preah Sihanouk Garden",
    category: "Park",
    categoryId: "Visit",
    image: "./images/sihanoukgarden.jpg",
    rating: 4.5,
    description: "A green public park popular for walking, exercising, and relaxing.",
    locationtxt: "Norodom Blvd",
    location: "https://maps.google.com/?q=Preah+Sihanouk+Garden+Phnom+Penh",
    area: "BKK1",
    price: "Free",
    reviews: ["Perfect for an evening walk under the trees."],
    tags: "bkk1"
  },
  {
    name: "Wat Ounalom",
    category: "Temple",
    categoryId: "Visit",
    image: "./images/ounalom.jpg",
    rating: 4.6,
    description: "The headquarters of Cambodian Buddhism with beautiful traditional architecture.",
    locationtxt: "Sisowath Quay",
    location: "https://maps.google.com/?q=Wat+Ounalom+Phnom+Penh",
    area: "Daun Penh",
    price: "Free",
    reviews: ["One of the city's most important and peaceful temples."],
    tags: "daunpenh"
  },
  {
    name: "Chaktomuk Riverside Park",
    category: "Park",
    categoryId: "Visit",
    image: "./images/chaktomukpark.jpg",
    rating: 4.5,
    description: "A scenic riverside park where the Mekong and Tonlé Sap rivers meet.",
    locationtxt: "Sisowath Quay",
    location: "https://maps.google.com/?q=Chaktomuk+Riverside+Park+Phnom+Penh",
    area: "Daun Penh",
    price: "Free",
    reviews: ["Beautiful place to watch boats and sunsets."],
    tags: "daunpenh"
  },
  {
    name: "Phsar Kandal",
    ...
    categoryId: "Visit",
    image: "./images/phsarkandal.jpg",
    rating: 4.4,
    description: "A lively local market famous for street food and Cambodian desserts.",
    locationtxt: "Street 154",
    location: "https://maps.google.com/?q=Phsar+Kandal+Phnom+Penh",
    area: "Daun Penh",
    price: "Free",
    reviews: ["Excellent market for authentic local food."],
    tags: "daunpenh"
  },
  {
    ...
    category: "Art Gallery",
    categoryId: "Visit",
    image: "./images/factoryart.jpg",
    rating: 4.6,
    description: "A contemporary gallery featuring exhibitions by Cambodian artists.",
    locationtxt: "Factory Phnom Penh",
    location: "https://maps.google.com/?q=Factory+Contemporary+Arts+Centre+Phnom+Penh",
    area: "TTP",
    price: "Free",
    reviews: ["Modern art and creative exhibitions in one place."],
    tags: "ttp"
  },
  {
    name: "TTP Community Park",
    category: "Park",
    categoryId: "Visit",
    image: "./images/ttppark.jpg",
    rating: 4.3,
    description: "A neighborhood green space with playgrounds and walking paths.",
    locationtxt: "Toul Tom Poung",
    location: "https://maps.google.com/?q=TTP+Community+Park+Phnom+Penh",
    area: "TTP",
    price: "Free",
    reviews: ["A relaxing place popular with local families."],
    tags: "ttp"
  },
  {
    name: "Vintage Market TTP",
    category: "Shopping",
    categoryId: "Visit",
    image: "./images/vintagettp.jpg",
    rating: 4.4,
    description: "A collection of vintage clothing stores and handmade boutiques.",
    locationtxt: "Street 454",
    location: "https://maps.google.com/?q=Vintage+Market+Toul+Tom+Poung+Phnom+Penh",
    area: "TTP",
    price: "Free",
    reviews: ["A great area for vintage shopping and unique finds."],
    tags: "ttp"
  },
  {
    name: "NagaWorld Entertainment Complex",
    category: "Entertainment",
    categoryId: "Visit",
    image: "./images/nagaworld.jpg",
    rating: 4.5,
    description: "A luxury entertainment complex with shopping, restaurants, and performances.",
    locationtxt: "Samdech Hun Sen Park",
    location: "https://maps.google.com/?q=NagaWorld+Phnom+Penh",
    area: "Tonle Bassac",
    price: "Free to enter",
    reviews: ["A lively destination with plenty to do indoors."],
    tags: "tonlebassac"
  },
  {
    name: "Koh Norea Riverside",
    category: "Riverside",
    categoryId: "Visit",
    image: "./images/kohnorea.jpg",
    rating: 4.6,
    description: "A newly developed riverside promenade with panoramic skyline views.",
    locationtxt: "Koh Norea",
    location: "https://maps.google.com/?q=Koh+Norea+Riverside+Phnom+Penh",
    area: "Tonle Bassac",
    price: "Free",
    reviews: ["One of the city's newest and most photogenic spots."],
    tags: "tonlebassac"
  },
  {
    name: "Bassac River Promenade",
    category: "Riverside Walk",
    categoryId: "Visit",
    image: "./images/bassacwalk.jpg",
    rating: 4.4,
    description: "A peaceful walkway along the Bassac River perfect for sunsets.",
    locationtxt: "Tonle Bassac",
    location: "https://maps.google.com/?q=Bassac+River+Promenade+Phnom+Penh",
    area: "Tonle Bassac",
    price: "Free",
    reviews: ["A relaxing riverside walk with beautiful evening views."],
    tags: "tonlebassac"
  },

  {
    name: "Prek Leap National College Garden",
    category: "Garden",
    categoryId: "Visit",
    image: "./images/prekleap.jpg",
    rating: 4.3,
    description: "A peaceful riverside garden surrounded by greenery.",
    locationtxt: "Prek Leap",
    location: "https://maps.google.com/?q=Prek+Leap+Phnom+Penh",
    area: "Chroy Changvar",
    price: "Free",
    reviews: ["A quiet escape from the busy city center."],
    tags: "chroychangvar"
  },
  {
    name: "Chroy Changvar Ferry Pier",
    category: "Riverside",
    categoryId: "Visit",
    image: "./images/ferrypier.jpg",
    rating: 4.2,
    description: "A local ferry terminal with great views of the rivers and skyline.",
    locationtxt: "Keo Chenda",
    location: "https://maps.google.com/?q=Chroy+Changvar+Ferry+Pier+Phnom+Penh",
    area: "Chroy Changvar",
    price: "Free",
    reviews: ["A great place to watch boats crossing the river."],
    tags: "chroychangvar"
  },
  {
    name: "Boeung Kak Lake View",
    category: "Lake",
    categoryId: "Visit",
    image: "./images/boeungkaklake.jpg",
    rating: 4.3,
    description: "A peaceful lakeside viewpoint with cafés nearby.",
    locationtxt: "Boeung Kak",
    location: "https://maps.google.com/?q=Boeung+Kak+Lake+Phnom+Penh",
    area: "Toul Kork",
    price: "Free",
    reviews: ["A nice place to relax and enjoy the sunset."],
    tags: "toulkork"
  },
  {
    name: "TK Street Art District",
    category: "Street Art",
    categoryId: "Visit",
    image: "./images/tkstreetart.jpg",
    rating: 4.2,
    description: "Colorful murals and creative walls throughout the neighborhood.",
    locationtxt: "Street 315",
    location: "https://maps.google.com/?q=TK+Street+Art+District+Phnom+Penh",
    area: "Toul Kork",
    price: "Free",
    reviews: ["A fun neighborhood for photography and murals."],
    tags: "toulkork"
  },
  {
    name: "De Castle Rooftop",
    category: "Viewpoint",
    categoryId: "Visit",
    image: "./images/decastle.jpg",
    rating: 4.4,
    description: "A rooftop viewpoint with panoramic views over Toul Kork.",
    locationtxt: "Toul Kork",
    location: "https://maps.google.com/?q=De+Castle+Rooftop+Phnom+Penh",
    area: "Toul Kork",
    price: "Free entry",
    reviews: ["Beautiful skyline views, especially at sunset."],
    tags: "toulkork"
  },
  {
    name: "Sen Sok Eco Park",
    category: "Park",
    categoryId: "Visit",
    image: "./images/ecopark.jpg",
    rating: 4.5,
    description: "A family-friendly green park with lakes and cycling paths.",
    locationtxt: "Sen Sok",
    location: "https://maps.google.com/?q=Sen+Sok+Eco+Park+Phnom+Penh",
    area: "Sen Sok",
    price: "Free",
    reviews: ["Great outdoor park for cycling and jogging."],
    tags: "sensok"
  },
  {
    ...
    rating: 4.6,
    description: "A large water park featuring slides and family attractions.",
    locationtxt: "Sen Sok",
    location: "https://maps.google.com/?q=Garden+City+Water+Park+Phnom+Penh",
    area: "Sen Sok",
    price: "$$",
    reviews: ["A fun destination for families and friends."],
    tags: "sensok"
  },
  {
    name: "Chip Mong Mega Mall 271",
    category: "Lifestyle Mall",
    categoryId: "Visit",
    image: "./images/chipmong271.jpg",
    rating: 4.6,
    description: "A modern shopping and entertainment mall with cinema and restaurants.",
    locationtxt: "271 Boulevard",
    location: "https://maps.google.com/?q=Chip+Mong+Mega+Mall+271+Phnom+Penh",
    area: "Sen Sok",
    price: "Free entry",
    reviews: ["One of the city's newest shopping destinations."],
    tags: "sensok"
  },

  {
    name: "Olympia Sky Garden",
    category: "Sky Garden",
    categoryId: "Visit",
    image: "./images/olympiasky.jpg",
    rating: 4.3,
    description: "A rooftop public garden with views of the surrounding skyline.",
    locationtxt: "Olympia City",
    location: "https://maps.google.com/?q=Olympia+Sky+Garden+Phnom+Penh",
    area: "Prampir Makara",
    price: "Free",
    reviews: ["A hidden rooftop spot with great city views."],
    tags: "prampirmakara"
  },
  {
    name: "Art Deco Central Market Dome",
    category: "Architecture",
    categoryId: "Visit",
    image: "./images/artdeco.jpg",
    rating: 4.5,
    description: "The iconic Art Deco dome and architecture of Central Market.",
    locationtxt: "Central Market",
    location: "https://maps.google.com/?q=Central+Market+Art+Deco+Phnom+Penh",
    area: "Prampir Makara",
    price: "Free",
    reviews: ["A beautiful architectural landmark in Phnom Penh."],
    tags: "prampirmakara"
  },
  {
    name: "Exchange Square Plaza",
    category: "Modern Plaza",
    categoryId: "Visit",
    image: "./images/exchangeplaza.jpg",
    rating: 4.2,
    description: "A modern public plaza surrounded by skyscrapers and cafés.",
    locationtxt: "Street 106",
    location: "https://maps.google.com/?q=Exchange+Square+Plaza+Phnom+Penh",
    area: "Prampir Makara",
    price: "Free",
    reviews: ["A clean and modern place to relax in the city."],
    tags: "prampirmakara"
  }
